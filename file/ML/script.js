...
const itemsData = {
    diamond: [
        { name: '3 Diamonds', price: 'Rp 1.500', icon: 'ML.png' },
        { name: '12 Diamonds', price: 'Rp 7.600', icon: 'ML.png' },
        { name: '44 Diamonds', price: 'Rp 15.200', icon: 'ML.png' },
        { name: '170 Diamonds', price: 'Rp 43.700', icon: 'ML.png' },
        { name: '568 Diamonds', price: 'Rp 142.500', icon: 'ML.png' },
        { name: '2010 Diamonds', price: 'Rp 475.000', icon: 'ML.png' },
    ],
    weeklyPass: [
        { name: 'Weekly Diamond Pass', price: 'Rp 20.000', icon: 'week.png' }
    ],
    twilightPass: [
        { name: 'Twilight Pass', price: 'Rp 50.000', icon: 'twili.png' }
    ]
};
...
document.getElementById('weeklyPass').addEventListener('click', () => renderItems('weeklyPass'));
document.getElementById('twilightPass').addEventListener('click', () => renderItems('twilightPass'));
