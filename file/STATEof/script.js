...
const itemsData = {
    diamond: [
        { name: '10 Diamonds', price: 'Rp 1.500', icon: 'state.png' },
        { name: '100 Diamonds', price: 'Rp 14.000', icon: 'state.png' },
        { name: '250 Diamonds', price: 'Rp 34.000', icon: 'state.png' },
        { name: '500 Diamonds', price: 'Rp 60.000', icon: 'state.png' },
        { name: '1000 Diamonds', price: 'Rp 120.000', icon: 'state.png' },
        { name: '5000 Diamonds', price: 'Rp 600.000', icon: 'state.png' },
    ]
};
